...
\address{1061, Maria Heilbuth Surette Apt. 303, Belo Horizonte, Minas Gerais, Brazil}

\mobile{(+55) 31-98213-8778}
\email{xandmaga@outlook.com}
\github{xandmaga}
\linkedin{xandmaga}
% \gitlab{gitlab-id}
...
\makecvfooter
  {\today}
  {Alexandre Furtado de M. Gomes~~~·~~~Curriculum Vitae}
  {\thepage}
